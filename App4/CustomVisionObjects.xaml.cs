...
namespace App5
{
    ...
    public sealed partial class CustomVisionObjects : Page
    {
        ...
        public static ICollection<string> vs = new Collection<string>() { "407a3dc2-dae0-4c89-8b62-4d0dee7cb29b" };//{ "aec426b4-759a-4486-ba4e-27a43b4d01d1" }; //{ "407a3dc2-dae0-4c89-8b62-4d0dee7cb29b" };
       ...
       Windows.Storage.ApplicationData.Current.LocalSettings;
        ...
        public List<string> lstObjetos = new List<string>() { "Agro Analisis", "Ganado" };
        ...
        private async void lstView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                case "Agro Analisis":
                    vs.Add("407a3dc2-dae0-4c89-8b62-4d0dee7cb29b");
                    break;
                case "Ganado":
                    vs.Add("aec426b4-759a-4486-ba4e-27a43b4d01d1");
                    break;
